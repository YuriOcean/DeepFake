...
if __name__ == "__main__":
    input_dir = "/data/disk2/yer/Dataset/val_split_images"
    output_csv = "/data/disk2/yer/Dataset/results/inference_results_val.csv"
    model_args = {
        "name": "BisaiBaseline",
        "init_config": {
        },
        "init_path": "/data/disk2/yer/ForensicHub/ForensicHub/statics/log/bisai1/checkpoint-0.pth"
    }
